...
public class FancyTankWeapon extends AbstractWeapon {
	...
	public void fireWeapon(Ship theTank) {
		...
		bullets[0] = new TankBullet(location, speed, strength, -5, (Koala) theTank);
		bullets[1] = new TankBullet(location, speed, strength, 5, (Koala) theTank);
